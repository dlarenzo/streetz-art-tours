...
const StreetArtzTours = () => {
  return (
    <section className="text-black w-full pt-40 px-2 flex justify-center mb-[5%] ">
      <div className="max-w-[1600px] m-auto px-12">
        <div className="w-full">
          ...
          <div className="flex gap-10 py-10">
            ...
            <div>
              <p>
                Our tours are perfect for art lovers, street art enthusiasts,
                and anyone who wants to explore the vibrant and dynamic world of
                street art. Whether you are a seasoned traveler or a first-time
                visitor, our tours are a great way to discover the hidden gems
                of the local street art scene and get a behind-the-scenes look
                at the artists and organizations that are shaping the urban
                landscape. <br />
              </p>
